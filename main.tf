...
module "github_repository" {
  source              = "github.com/RomanDemianenko/tf-github-repository"
...
module "flux_bootstrap" {
  source            = "github.com/RomanDemianenko/tf-fluxcd-flux-bootstrap?ref=gke_auth"
...
module "tls_private_key" {
  source = "github.com/RomanDemianenko/tf-hashicorp-tls-keys"
  algorithm   = "RSA"
}
